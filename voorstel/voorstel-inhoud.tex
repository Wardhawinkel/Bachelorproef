...
\begin{itemize}
  \item kaderen thema
Digitale veiligheid is een essentiële vaardigheid geworden in een samenleving waar technologische vooruitgang niet stilstaat. Wachtwoordmanagers zijn een belangrijk hulpmiddel om sterke, unieke wachtwoorden te genereren en beheren, wat cruciaal is voor het beschermen van persoonlijke digitale gegevens. 
Uit een wereldwijde survey van Bitwarden (2022) blijkt dat 32\% van de respondenten wachtwoorden hergebruikt over meerdere sites, 55\% vertrouwen op geheugen voor wachtwoorden en slechts 34\% gebruiken een wachtwoordmanager \autocite{Bitwarden2024}. Hieruit blijkt dat er een aanzienlijke kloof bestaat tussen de kennis over veilig wachtwoordbeheer en het gebruik ervan.
...
\item Probleemstelling en onderzoeksvraag
...
%Je mag deze sectie nog verder onderverdelen in subsecties als dit de structuur van de tekst kan verduidelijken.
 ...
 Het belang van veilig wachtwoordbeheer wordt in de literatuur vaak benadrukt. Gebruikers die hun wachtwoorden hergebruiken over meerdere sites lopen een verhoogd risico op cyberaanvallen \autocite{Gaw2006}. Studies tonen aan dat het gebruik van wachtwoordmanagers niet langer een luxe is, maar een noodzaak voor het behouden van digitale veiligheid \autocite{CMU2025}.
 Echter blijkt uit onderzoek dat veel beginnende gebruikers terughoudend zijn om deze tools te gebruiken. Volgens \textcite{Pearman2019} ervaren gebruikers vaak een gebrek aan vertrouwen in de beveiliging van wachtwoordmanagers, evenals zorgen over de complexiteit van het gebruik ervan. Sommige gebruikers geven aan niet te weten dat er betere opties beschikbaar zijn dan het simpelweg onthouden van wachtwoorden of het opschrijven ervan.  
 Binnen security awareness wordt steeds duidelijker dat traditionele methoden zoals tekstuele handleidingen of tutorials niet voldoende zijn om gebruikers effectief te trainen in veilig wachtwoordbeheer. Een belangrijke reden hiervoor is dat gebruikers wel advies krijgen over veilig gedrag, maar dit niet in de praktijk kunnen brengen zonder risico op fouten of datalekken \autocite{Sugatan2020}. \textcite{Sugatan2020} gebruikte in hun onderzoek een interactieve, verhalende leeromgeving waar gebruikers de kans kregen om beslissingen te nemen rond wachtwoordgedrag en vervolgens ook de gevolgen te zien. De onderzoekers stelde vast dat deze aanpak leidde tot een beter begrip, meer vertrouwen en een grotere bereidheid om zelf een wachtwoordmanager te gebruiken.
 Dit onderzoek benadrukt het potentieel van interactieve simulaties als een effectieve methode om beginnende gebruikers te trainen in veilig wachtwoordbeheer.
 
 \textcite{Zawalnyski2025} verdeeld wachtwoordmanagers in drie categorieën: browser-, cloud- en desktop-based. Verschillende internet browsers zoals Google Chrome en Safari, bieden ingebouwde wachtwoordmanagers aan die gebruikers in staat stellen om wachtwoorden op te slaan en automatisch in te vullen. Cloud-gebaseerrde wachtwoordmanagers worden meestal gedownload en beheerd op mobiele apparaten of desktop. Dit type slaan wachtwoorden op in een beveiligde cloudomgeving. Desktop-gebasseerde wachtwoordmanagers worden lokaal op de computer geïnstalleerd en slaan wachtwoorden lokaal op. Elk type heeft zijn voor- en nadelen, afhankelijk van de behoeften van de gebruiker.
