...
% Definieer kleuren
\definecolor{probleemstelling}{RGB}{255, 255, 0}       % geel
\definecolor{hoofdvraag}{RGB}{0, 0, 255}             % blauw
\definecolor{deelvraagprobleem}{RGB}{0, 128, 0}      % groen
\definecolor{deelvraagoplossing}{RGB}{255, 165, 0}   % oranje
\definecolor{doelstelling}{RGB}{192, 192, 192}       % lichtgrijs voor doelstelling
...
% TODO: Werktitel
\title{Webgebaseerde simulatie voor beginnende gebruikers: Een onderzoek naar de geschiktheid van Unity voor het aanleren van het gebruik van wachtwoordmanager}
...
\projectrepo{https://github.com/Wardhawinkel/Bachelorproef}
